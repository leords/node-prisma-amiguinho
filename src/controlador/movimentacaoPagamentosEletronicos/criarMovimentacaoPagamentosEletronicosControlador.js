...
import { CriarMovimentacaoPagamentosEletronicosServico } from '../../servico/movimentacaoPagamentosEletronicos/criarMovimentacaoPagamentosEletronicosServico.js'
import { coletarErro } from '../../utilidades/coletarErro.js'

class CriarMovimentacaoPagamentosEletronicosControlador {
  async tratar(req, res, next) {
    ...
    try {
      ...
      const resultado = new CriarMovimentacaoPagamentosEletronicosServico()
...
export { CriarMovimentacaoPagamentosEletronicosControlador }
